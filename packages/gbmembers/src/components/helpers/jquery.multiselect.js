...
(function($) {
  var defaults = {
    ...
    customPlaceholder: false, //Added to allow setting custom placeholder for campaign recipients dropdown
  ...
  MultiSelect.prototype = {
    ...
    load: function() {
      ...
      $(instance.element).after(
        '<div class="ms-options-wrap"><button type="button"><span>None Selected</span></button><div class="ms-options"><ul></ul></div></div>',
      );
        ...
        .bind('mousedown', function(event) {
          ...
          $('.ms-options-wrap.ms-active > .ms-options').each(function() {
            if (
              $(this)
                .parent()
                .prev()[0] !== optionsWrap.parent().prev()[0]
            ) {
              $(this)
                .closest('.ms-options-wrap')
                .removeClass('ms-active');
      ...
      optionsWrap.on('click', '.ms-selectall', function(event) {
        ...
        if ($(this).hasClass('global')) {
          ...
          if (
            optionsList.find('li:not(.optgroup, .selected, .ms-hidden)').length
          ) {
          ...
          // deselect everything
            ...
            optionsList
              .find('li:not(.optgroup, .ms-hidden).selected')
          ...
          // deselect everything
            ...
            optgroup
              .find('li:not(.ms-hidden).selected')
              .removeClass('selected');
            optgroup
              .find(
    ...
    loadOptions: function(options, overwrite, updateSelect) {
      ...
      for (var key in options) {
        ...
        // OPTGROUP
          ...
          var optGroup = $(
            '<optgroup label="' + thisOption.label + '"></optgroup>',
          );
    ...
    _updatePlaceholderText: function() {
      ...
      if (!this.options.customPlaceholder) {
        //Added to allow setting custom placeholder for campaign recipients dropdown
      ...
      // if copy is larger than button width use "# selected"
        ...
        placeholderTxt.text(
          select.val().length + instance.options.texts.selectedOptions,
        );
      }
    },
