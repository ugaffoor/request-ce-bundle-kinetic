...
export class MemberActivityReport extends Component {
  constructor(props) {
    ...
    this.allColumns = [
      ...
      { title: 'Additional Email', field: 'additionalEmail', tooltip: true },
      ...
      { title: 'Archive Billing Id', field: 'archiveBillingId' },
      { title: 'Archive Billing Reference', field: 'archiveBillingReference' },
    ...
    this.hiddenColumns = [
      ...
      { label: 'Additional Email', value: 'additionalEmail' },
      ...
      { label: 'Archive Billing Id', value: 'archiveBillingId' },
      { label: 'Archive Billing Reference', value: 'archiveBillingReference' },
      { label: 'Non Paying', value: 'nonPaying' },
      { label: 'Send Payment Receipt', value: 'sendPaymentReceipt' },
    ...
    if (Utils.isMemberOf(this.props.profile, 'Billing')) {
      this.columnsToHide.push({
        ...
        options: [
          ...
          { label: 'Archive Billing Id', value: 'archiveBillingId' },
          {
            label: 'Archive Billing Reference',
            value: 'archiveBillingReference',
          },
          { label: 'Non Paying', value: 'nonPaying' },
          { label: 'Send Payment Receipt', value: 'sendPaymentReceipt' },
          { label: 'Last Payment Date', value: 'lastPaymentDate' },
  ...
  getGridData(members) {
    ...
    members.forEach(member => {
      memberActivityData.push({
        ...
        additionalEmail: member.values['Additional Email'],
        phone: member.values['Phone Number'],
        additionalPhone: member.values['Additional Phone Number'],
