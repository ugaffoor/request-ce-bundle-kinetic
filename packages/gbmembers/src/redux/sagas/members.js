...
export function* syncBillingCustomer(action) {
  ...
  */
    ...
    console.log('Error in syncBillingCustomer: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* fetchNewCustomers(action) {
  try {
    ...
    console.log('Error in fetchNewCustomers: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* editPaymentAmount(action) {
  try {
    ...
    axios
      .post(
        appSettings.kineticBillingServerUrl + ChangeScheduledAmountUrl,
        args,
      )
      .then(result => {
        if (result.data.error && result.data.error > 0) {
    ...
    console.log('Error in editPaymentAmount: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* fetchPaymentHistory(action) {
  try {
    ...
    console.log('Error in fetchPaymentHistory: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* fetchOverdues(action) {
  try {
    ...
    console.log('Error in fetchOverdues: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* fetchBillingPayments(action) {
  try {
    ...
    console.log('Error in fetchBillingPayments: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
export function* createBillingStatistics(action) {
  try {
    ...
    console.log('Error in createBillingStatistics: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* fetchProcessedAndScheduledPayments(action) {
  try {
    ...
    console.log(
      'Error in fetchProcessedAndScheduledPayments: ' + util.inspect(error),
    );
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* clearPaymentSchedule(action) {
  try {
    ...
    console.log('Error in clearPaymentSchedule: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* registerBillingMember(action) {
  try {
    ...
    if (args.paymentMethod === 'Credit Card') {
      ...
      args.creditCardType =
        action.payload.billingInfo.values['Credit Card Type'];
    ...
    axios
      ...
      .then(result => {
        if (result.data.error && result.data.error > 0) {
          console.log(
            'registerBillingMember Error: ' + result.data.errorMessage,
          );
          action.payload.addNotification(
            NOTICE_TYPES.ERROR,
            result.data.errorMessage,
    ...
    console.log('Error in registerBillingMember: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* editPaymentMethod(action) {
  try {
    ...
    console.log('Error in editPaymentMethod: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* refundTransaction(action) {
  try {
    ...
    console.log('Error in refundTransaction: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* refundPOSTransaction(action) {
  try {
    ...
    axios
      ...
      .then(result => {
        ...
        if (result.data.error && result.data.error > 0) {
          ...
          var products = JSON.parse(order['POS Checkout JSON'])[
            'Checkout Items'
          ].products;
    ...
    console.log('Error in refundPOSTransaction: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
  ...
  try {
    ...
    axios
      ...
      .then(result => {
        if (result.data.error && result.data.error > 0) {
          console.log(
            'fetchCustomerRefunds Error: ' + result.data.errorMessage,
          );
          if (action.payload.addNotification) {
            action.payload.addNotification(
              NOTICE_TYPES.ERROR,
    ...
    console.log('Error in fetchCustomerRefunds: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* fetchBillingCustomers(action) {
  try {
    ...
    console.log('Error in fetchBillingCustomers: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* createBillingMembers(action) {
  try {
    ...
    console.log('Error in createBillingMembers: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
...
export function* syncBillingMembers(action) {
  try {
    ...
    console.log('Error in syncBillingMembers: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
export function* fetchInactiveCustomersCount(action) {
  try {
    ...
    console.log('Error in fetchInactiveCustomersCount: ' + util.inspect(error));
    yield put(errorActions.setSystemError(error));
  }
}
