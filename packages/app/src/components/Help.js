  ...
  <Dropdown isOpen={isOpen} toggle={toggle}>
    ...
    <DropdownMenu right className="help-menu">
      ...
      <ul className="help-list">
        {Help.filter(help => {
          if (viewBy === 'members' && help.values['Application'] === 'Members')
            return true;
          if (
            viewBy === 'services' &&
            ...
            return true;
          if (viewBy === 'waivers' && help.values['Application'] === 'Waivers')
            return true;
          ...
          .map(help => (
            <li key={help.id} className="event-item">
              ...
              <span
                ...
                dangerouslySetInnerHTML={{ __html: help.values['Information'] }}
              ></span>
            </li>
          ))}
        {Help.size < 1 && (
